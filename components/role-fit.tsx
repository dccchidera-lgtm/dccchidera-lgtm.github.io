...
const roles = [
  {
    ...
    headline:
      "I structure business questions, test key trade-offs and explain how the evidence supports a recommendation.",
    summary:
  ...
  },
  {
    ...
    headline:
      "I assess data quality, select an appropriate method and communicate the limits as clearly as the result.",
    summary:
  ...
  },
  {
    ...
    label: "Customer & CRM",
    headline:
      "I combine customer context with structured research and responsible interpretation.",
    summary:
  ...
  },
  {
    ...
    headline:
      "I connect audience understanding and digital measurement with evidence-led optimisation.",
    summary:
    ...
    evidence: [
      ...
      },
      {
        name: "Customer Intelligence",
        detail:
          "Customer research connecting personalisation, trust and loyalty",
        ownership: "Individual dissertation",
        href: "/work/customer-intelligence",
      },
    ],
  },
  {
    ...
    label: "Digital & AI",
    headline:
      "I evaluate how data, automation and digital change can support a business decision responsibly.",
    summary:
    ...
    evidence: [
      {
        ...
        detail:
          "Cloud scaling, merchant capability and responsible platform change",
  ...
  return (
    ...
    >
      <div className="shell role-fit-heading" data-reveal>
        ...
        <h2 id="role-fit-title">Find the experience relevant to your role.</h2>
      </div>

      <div className="shell role-fit-shell" data-reveal>
        <div
          className="role-fit-tabs"
          role="group"
          aria-label="Choose a role lens"
        >
        ...
        >
          ...
          <p className="role-fit-note">
            Ownership is stated per case. Team evidence is never presented as
            sole output.
          </p>
        </article>
      </div>
