...
export function InteractiveEvidenceLab() {
  ...
  return (
    <div className="evidence-lab" data-reveal>
      <div className="evidence-lab-tabs" role="group" aria-label="Choose an analytical visual">
        ...
        <button type="button"  aria-pressed={view === 'mediation'} onClick={() => setView('mediation')}>
          <span>03</span> Mediation model
        </button>
      </div>

      {view === 'models' && (
        <section className="evidence-lab-panel" role="region" aria-labelledby="model-visual-title">
          ...
          <div className="lab-chart" role="group" aria-label={`Validation ${metric === 'error' ? 'misclassification' : 'accuracy'} comparison for three churn models`}>
      ...
      {view === 'network' && (
        <section className="evidence-lab-panel" role="region" aria-labelledby="network-visual-title">
          <div className="evidence-lab-copy">
